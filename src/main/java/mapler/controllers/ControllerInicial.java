...
public class ControllerInicial implements Initializable {
    ...
    private void modoInicial() {
		...
		try {
			AnchorPane ap_codigo = FXMLLoader.load(getClass().getClassLoader().getResource("view/tela_principal.fxml"));
			setCenter(ap_codigo);
    ...
    private void modoCodigo() {
    	...
    	try {
    		AnchorPane ap_codigo = FXMLLoader.load(getClass().getClassLoader().getResource("view/tela_codigo.fxml"));
    		setCenter(ap_codigo);
